...
import org.sansovo.demo.spring5adv.ch6.CleanUp;
 ...
 */
@Configuration
@ComponentScan(basePackages = "org.sansovo.demo.spring5adv.ch7")
...
public class AdvancedConfig {
	...
	public SessionFactory sessionFactory() {
		return new LocalSessionFactoryBuilder(dataSource())
				.scanPackages("org.sansovo.demo.spring5adv.ch7.entities")
