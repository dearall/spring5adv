package org.sansovo.demo.spring5adv.ch8.config;
...
@ComponentScan(basePackages = {"org.sansovo.demo.spring5adv.ch8"})
@EnableJpaRepositories(basePackages = {"org.sansovo.demo.spring5adv.ch8.repos"})
...
public class EnversConfig {
	...
	public Properties hibernateProperties() {
		...
		hibernateProp.put("org.hibernate.envers.audit_strategy", "org.hibernate.envers.strategy.internal.ValidityAuditStrategy");
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factoryBean.setPackagesToScan("org.sansovo.demo.spring5adv.ch8.entities");
